...
function ProfileVisual() {
  ...
  return (
    <div className="relative ml-auto aspect-square w-full max-w-[280px] sm:max-w-[380px]">
      <div
...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative overflow-hidden pt-24 sm:pt-32">
      ...
      <div className="container-content grid items-center gap-10 pb-6 sm:pb-10 lg:grid-cols-[1.3fr_0.7fr] lg:gap-6">
        <motion.div
